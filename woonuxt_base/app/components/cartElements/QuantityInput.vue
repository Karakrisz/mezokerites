...
<template>
  <div class="flex rounded bg-white text-sm leading-none shadow-sm shadow-stone-200 isolate">
    <button
      ...
      type="button"
      class="focus:outline-none border-r w-10 h-10 border rounded-l border-stone-300 hover:bg-stone-50 disabled:cursor-not-allowed"
    ...
    <input
      ...
      aria-label="Quantity"
      @focusout="onFocusOut"
      class="flex items-center text-center justify-center w-10 px-2 text-xs focus:outline-none border-y border-stone-300" />
    <button
      title="Increase Quantity"
      aria-label="Increase Quantity"
      @click="incrementQuantity"
      type="button"
      class="focus:outline-none border-l w-10 h-10 border rounded-r hover:bg-stone-50 border-stone-300 disabled:cursor-not-allowed disabled:bg-stone-100"
