    ...
    <Transition name="pop-in" mode="out-in">
      <span v-if="avatar" class="relative avatar">
        ...
        <div class="account-dropdown">
          <NuxtLink :to="wishlistLink" class="hover:bg-stone-100"><Icon name="ion:heart-outline" size="16" /><span>Kívánságlista</span></NuxtLink>
          <NuxtLink to="/my-account" class="hover:bg-stone-100"><Icon name="ion:person-outline" size="16" /><span>Profil</span></NuxtLink>
      ...
      <Icon v-else name="ph:user" size="32" style="color: black" />
    </Transition>
  </NuxtLink>
</template>
